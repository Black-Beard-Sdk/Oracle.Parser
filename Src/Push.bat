XCOPY .\Black.Beard.Oracle.Model\bin\Debug\netstandard2.0\*.* ..\..\tfs\SqlGenerator\Developpement\V10\ThirdParty /s /e /y

XCOPY .\Black.Beard.Oracle.Parser\bin\Debug\*.* ..\..\tfs\SqlGenerator\Developpement\V10\ThirdParty /s /e /y
